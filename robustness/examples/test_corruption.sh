...
srun python create_corruptions.py --CUDA --dataset cityscapes --model swiftnet  --weights /beegfs/data/shared/init_weights/SwiftNet_ss/official_pretrained/models/weights_0/model.pth